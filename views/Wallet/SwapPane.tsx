...
> {
    ...
    render() {
                        ...
                        {isRecovering && recoveryProgress !== 1 && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {`${localeString(
                                            'views.Wallet.SwapPane.recovery.title'
                                        )}${
                                            !recoveryProgress
                                                ? ` - ${localeString(
                                                      'views.Wallet.SwapPane.recovery.textAlt'
                                                  ).replace('Zeus', 'ZEUS')}`
                                                : ''
                                        }`}
                                    </Text>
                                    {recoveryProgress && (
                                        ...
                                        >
                                            {localeString(
                                                'views.Wallet.SwapPane.recovery.text'
                                            ).replace('Zeus', 'ZEUS')}
                                        </Text>
                                    )}
                                    {recoveryProgress && (
                        ...
                        {isSyncing && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {localeString(
                                            'views.Wallet.SwapPane.sync.title'
                                        )}
                                    </Text>
                                    <Text
                                        style={{
                                    ...
                                    >
                                        {localeString(
                                            'views.Wallet.SwapPane.sync.text'
                                        ).replace('Zeus', 'ZEUS')}
                                    </Text>
                            ...
                            !BalanceStore.loadingLightningBalance && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {localeString(
                                                'views.Wallet.SwapPane.backup.title'
                                            )}
                                        </Text>
                                        <Text
                                            style={{
                                        ...
                                        >
                                            {localeString(
                                                'views.Wallet.SwapPane.backup.text'
                                            )}
                                        </Text>
                                        <Text
                                            style={{
                                        ...
                                        >
                                            {localeString(
                                                'views.Wallet.SwapPane.backup.action'
                                            )}
                                        </Text>
                                    </View>
                                </TouchableOpacity>
        ...
        return <React.Fragment>{SwapPane}</React.Fragment>;
    }
}
