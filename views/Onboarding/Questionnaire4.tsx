...
@observer
export default class Questionnaire4 extends React.Component<
    Questionnaire4Props,
    Questionnaire4State
> {
    state = {
        ...
        return (
            <Screen>
                <Header
                    leftComponent="Back"
                    centerComponent={{
                        text: localeString('views.Onboarding3.title'),
                        style: {
                ...
                >
                    <Button
                        title={localeString('views.Onboarding3.createWallet')}
