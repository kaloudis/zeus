...
interface Questionnaire3Props {
    navigation: StackNavigationProp<any, any>;
    CashuStore: CashuStore;
    SettingsStore: SettingsStore;
    route: Route<'Questionnaire3', { enableCashu: boolean; returnTo?: string }>;
}

interface Questionnaire3State {
...
@observer
export default class Questionnaire3 extends React.Component<
    Questionnaire3Props,
    Questionnaire3State
> {
    state: Questionnaire3State = {
        discoverMode: 'zeus',
        customNpub: '',
        npubError: '',
        hasFetched: false,
        ...
        return (
            <Screen>
                <Header
                    leftComponent="Back"
                    centerComponent={{
                        text: localeString('views.Questionnaire3.title'),
                        style: {
                            color: themeColor('text'),
                ...
                >
                    ...
                    >
                        {localeString('views.Questionnaire3.subtitle')}
                    </Text>
                    ...
                    {this.renderRadioOption(
                        'later',
                        'views.Questionnaire3.chooseLater',
                        'views.Questionnaire3.chooseLater.description'
                    )}
                    ...
                    {discoverMode === 'custom' && (
                        <View style={styles.npubInputContainer}>
                            ...
                            <View style={{ marginTop: 10 }}>
                                <Button
                                    title={localeString(
                                        'views.Questionnaire3.fetchMints'
                                    )}
                    ...
                    {hasFetched && discoverMode !== 'later' && (
                        <View style={styles.mintsSection}>
                            ...
                            >
                                {localeString('views.Questionnaire3.topMints')}
                            </Text>
                            ...
                            {isLoading ? (
                                ...
                                topMints.map((mint: ScoredMint) => {
                                    ...
                                    const showIcon =
                                        iconUrl &&
                                        !this.state.failedIcons.has(mint.url);
                ...
                >
                    <Button
                        title={localeString('views.Questionnaire3.next')}
