...
> {
    ...
    recover = async () => {
        ...
        if (!selectedMintUrl) {
            this.setState({
                error: localeString(
                    'views.Cashu.RecoverMintQuote.noMintSelected'
                )
            });
            return;
        }
        ...
        return (
            <Screen>
                ...
                <ScrollView style={styles.container}>
                    ...
                    >
                        {localeString(
                            'views.Cashu.RecoverMintQuote.selectMint'
                        )}
                    </Text>
                    ...
                    <TextInput
                        value={quoteId}
                        onChangeText={(v) => this.setState({ quoteId: v })}
                        editable={!checking}
                        autoCapitalize="none"
                        autoCorrect={false}
                    ...
                    {checked && !error && recoveredAmount > 0 && (
                        <View style={styles.resultContainer}>
                            ...
                            >
                                {`${localeString(
                                    'views.Cashu.RecoverMintQuote.recovered'
